...
command! -range FmAbove FoldMarker a n
command! -range FmBelow FoldMarker b n
command! -range FmLine FoldMarker l n
...
command! -range FmLineNoNum FoldMarker l N
command! -range FmSurroundNoNum FoldMarker s N
